...
const ShuntWSSAnalyzer = () => {
  ...
  const drawBullseye = (results) => {
    ...
    results.forEach(s => {
      const sa = (s.angle - 90) * Math.PI / 180, ea = (s.angle + (360 / config.sectorCount) - 90) * Math.PI / 180;
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 h-[400px] flex flex-col">
            ...
            <div className="flex-1 min-h-0 min-w-0 relative">
              ...
              >
                {/* ✅ 解析中は Recharts を描画しない（DOM insertBefore 事故を回避） */}
                {isPlaying ? (
                  ...
                  graphW > 0 ? (
                    <div key={`${graphMode}-${graphW}-${sectorResults.length}-${timeSeriesData.length}`}>
          ...
          >
            ...
            <div className="absolute top-4 left-4 z-10 flex flex-col gap-2">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors border ${interactionMode === 'delete'
              ...
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors border ${interactionMode === 'move'
              ...
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors border ${interactionMode === 'rotate'
